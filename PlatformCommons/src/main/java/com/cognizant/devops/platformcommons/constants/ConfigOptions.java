...
public interface ConfigOptions {
	...
	String PLATFORM_AUDIT_SERVICE = "PlatformAuditService";
	...
	String REPORT_LOGS_PATH = System.getenv().get(INSIGHTS_HOME) + FILE_SEPERATOR + ConfigOptions.LOGS_FOLDER + FILE_SEPERATOR + ConfigOptions.PLATFORM_AUDIT_SERVICE + FILE_SEPERATOR + ConfigOptions.REPORTS_FOLDER;
