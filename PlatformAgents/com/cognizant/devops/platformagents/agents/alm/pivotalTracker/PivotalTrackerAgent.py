...
#                     dateCheck = lambda lastUpdatedDate: activity.get('occurred_at', '') if self.startFrom < \
#                                                                                 activity.get('occurred_at', '') else self.startFrom
...
#                     dateCheck = lambda lastUpdatedDate: story.get('updated_at', '') if self.startFrom < \
#                                                                                 story.get('updated_at', '') else self.startFrom
#                     lastUpdatedDate=dateCheck(story.get('updated_at', ''))
    ...
    def getProjectList(self):
        ...
        allProjects = self.getResponse(self.baseEndPoint + "/services/v5/projects" ,
                                            'GET', self.userid, self.password, None, reqHeaders=self.reqHeaders)
